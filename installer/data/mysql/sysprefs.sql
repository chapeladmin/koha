...
('f1Authentication', '0', 'Enable or disable authentication via Fellowship One', '', 'YesNo'),
('f1Staging', '1', 'Enable or disable using Fellowship One staging area for testing', '', 'YesNo'),
('f1ChurchCode', '', 'Your Fellowship One Church Code as used in the Portal login', '', 'Free'),
('f1ClientKey', '', 'Client Key is acquired from Fellowship One\'s API key', '', 'Free'),
('f1ClientSecret', '', 'Client Secret is acquired from Fellowship One\'s API key', '', 'Free'),
('f1DefaultBranchAttribute', 'Koha Default Branch', 'Fellowship One attribute name for default branch assingment (default of \'Koha Default Branch\')', '', 'Free'),
('f1PatronTypeAttribute', 'Koha Patron Type', 'Fellowship One attribute name for patron type assingment (default of \'Koha Patron Type\')', '', 'Free'),
